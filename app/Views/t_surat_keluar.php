    ...
    <div class="row" id="basic-table">
        <div class="col-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Form Utama -->
                    <form method="POST" action="<?= base_url('home/aksi_t_surat_keluar') ?>" id="modalForm" enctype="multipart/form-data">
        ...
        <div class="modal-form">
            <div class="row">
                ...
                <div class="col-md-7 mb-3">
                    ...
                    <input type="email" class="form-control" name="penerima" placeholder="Masukkan penerima" required>
                </div>
