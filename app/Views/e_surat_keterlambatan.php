        ...
        <div class="col-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">EDIT SURAT KETERLAMBATAN</h4>
                </div>
                <div class="card-body">
                    <!-- Form Utama -->
                    <form method="POST" action="<?= base_url('home/aksi_e_surat_keterlambatan') ?>" id="modalForm" enctype="multipart/form-data">
                            ...
                            <div class="modal-form">
                                <div class="row">
                                    <div class="col-md-7 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nama" placeholder="Masukkan nomor surat" value ="<?= $satu->nama ?>" >
                                    </div>
                                    <div class="col-md-7 mb-3">
                                        <label for="nomor_surat">NIK:</label>
                                        <input type="text" class="form-control" name="nik" placeholder="Masukkan nomor surat" value ="<?= $satu->nik ?>" >
                                    </div>
                                    <div class="col-md-7 mb-3">
                                    ...
                                    <div class="col-md-7 mb-3">
                                        ...
                                        <input type="time" class="form-control" id="jam_kedatangan" name="jam_kedatangan" value ="<?= $satu->jam_kedatangan ?>" >
                                    </div>
                                    <div class="col-md-7 mb-3">
                                        <label for="jumlah_keterlambatan">Jumlah Keterlambatan:</label>
                                        <input type="text" class="form-control" id="jumlah_keterlambatan" name="jumlah_keterlambatan" value ="<?= $satu->jumlah_keterlambatan ?>" readonly>
                                    </div>
                                    <div class="form-group col-md-7 mb-3">
    <label for="exampleFormControlTextarea1" class="form-label">Alasan:</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" name="alasan" rows="2" placeholder="Masukkan Alasan"><?= $satu->alasan ?></textarea>
</div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                            <input type="hidden" name="id" value="<?= $satu->id_surat_keterlambatan ?>">
